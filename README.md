...
- **应用管理**：Catalina 应用（Tomcat 6/7/8/9/10/11、WebLogic）容器与 Spring Framework 运行时管理；支持 idle 部署 / puppet 注入全局 ClassLoader 等场景（线程扫描 + JMX MBean 双兜底），可即时卸载 Filter / Servlet / Valve / Listener / Controller / Interceptor
