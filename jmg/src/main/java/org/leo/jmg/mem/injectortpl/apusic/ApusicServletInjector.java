...
public class ApusicServletInjector {
    ...
    public void inject(Object context, Object servlet) throws Exception {
        ...
        invokeMethod(webModule, "addServlet", new Class[]{String.class, String.class}, new Object[]{shellClassName, shellClassName});
        invokeMethod(servletMapper, "addMapping", new Class[]{String.class, boolean.class, String[].class}, new Object[]{shellClassName, true, new String[]{urlPattern}});
    }
