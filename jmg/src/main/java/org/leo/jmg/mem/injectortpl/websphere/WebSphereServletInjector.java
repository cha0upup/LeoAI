...
public class WebSphereServletInjector {
    ...
    public void inject(Object context, Object servlet) throws Exception {
        ...
        invokeMethod(context, "addDynamicServlet", new Class[]{String.class, String.class, String.class, Properties.class}, new Object[]{shellClassName, shellClassName, urlPattern, null});
    }
